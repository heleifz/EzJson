#ifndef __EZ_JSON_SCANNER__
#define __EZ_JSON_SCANNER__
...
public:
		...
		while (*tokenEnd != '\0')
		{
			...
			case NUMCONTENT:
				...
				else if (*tokenEnd == '.')
				{
					...
					while (isDigit(*tokenEnd))
					{
						fractionVal = fractionVal * 10 + (*tokenEnd - '0');
						fracCount--;
						tokenEnd++;
					}
					if (*tokenEnd == 'e' || *tokenEnd == 'E')
	...
	void match(TokenType t, double& v)
	{
		if (t == NUM)
		{
			v = value;
